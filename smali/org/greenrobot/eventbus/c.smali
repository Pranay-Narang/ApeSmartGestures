...
.field private final i:Lorg/greenrobot/eventbus/j;

.field private final j:Lorg/greenrobot/eventbus/n;

.field private final k:Lorg/greenrobot/eventbus/b;

.field private final l:Lorg/greenrobot/eventbus/a;

.field private final m:Lorg/greenrobot/eventbus/r;
...
.field private final v:Lorg/greenrobot/eventbus/i;
...
.method constructor <init>(Lorg/greenrobot/eventbus/f;)V
    ...
    .line 110
    invoke-virtual {p1}, Lorg/greenrobot/eventbus/f;->a()Lorg/greenrobot/eventbus/i;

    move-result-object v0

    iput-object v0, p0, Lorg/greenrobot/eventbus/c;->v:Lorg/greenrobot/eventbus/i;
    ...
    .line 114
    invoke-virtual {p1}, Lorg/greenrobot/eventbus/f;->b()Lorg/greenrobot/eventbus/j;

    move-result-object v0

    iput-object v0, p0, Lorg/greenrobot/eventbus/c;->i:Lorg/greenrobot/eventbus/j;

    .line 115
    iget-object v0, p0, Lorg/greenrobot/eventbus/c;->i:Lorg/greenrobot/eventbus/j;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/greenrobot/eventbus/c;->i:Lorg/greenrobot/eventbus/j;

    invoke-interface {v0, p0}, Lorg/greenrobot/eventbus/j;->a(Lorg/greenrobot/eventbus/c;)Lorg/greenrobot/eventbus/n;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lorg/greenrobot/eventbus/c;->j:Lorg/greenrobot/eventbus/n;
    ...
    .line 119
    new-instance v0, Lorg/greenrobot/eventbus/r;
    ...
    invoke-direct {v0, v1, v2, v3}, Lorg/greenrobot/eventbus/r;-><init>(Ljava/util/List;ZZ)V

    iput-object v0, p0, Lorg/greenrobot/eventbus/c;->m:Lorg/greenrobot/eventbus/r;
...
.method private a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    check-cast v1, Lorg/greenrobot/eventbus/s;

    .line 228
    iget-object v5, v1, Lorg/greenrobot/eventbus/s;->a:Ljava/lang/Object;

    if-ne v5, p1, :cond_1

    .line 229
    iput-boolean v4, v1, Lorg/greenrobot/eventbus/s;->c:Z
...
.method private a(Ljava/lang/Object;Lorg/greenrobot/eventbus/c$a;)V
    ...
    .line 391
    iget-object v0, p0, Lorg/greenrobot/eventbus/c;->v:Lorg/greenrobot/eventbus/i;
    ...
    invoke-interface {v0, v1, v2}, Lorg/greenrobot/eventbus/i;->a(Ljava/util/logging/Level;Ljava/lang/String;)V
    ...
    const-class v0, Lorg/greenrobot/eventbus/p;
    ...
    invoke-direct {v0, p0, p1}, Lorg/greenrobot/eventbus/k;-><init>(Lorg/greenrobot/eventbus/c;Ljava/lang/Object;)V
...
.method private a(Ljava/lang/Object;Lorg/greenrobot/eventbus/q;)V
    .locals 7

    .prologue
    .line 150
    iget-object v3, p2, Lorg/greenrobot/eventbus/q;->c:Ljava/lang/Class;

    .line 151
    new-instance v4, Lorg/greenrobot/eventbus/s;

    invoke-direct {v4, p1, p2}, Lorg/greenrobot/eventbus/s;-><init>(Ljava/lang/Object;Lorg/greenrobot/eventbus/q;)V
    ...
    iget v6, p2, Lorg/greenrobot/eventbus/q;->d:I

    invoke-virtual {v1, v2}, Ljava/util/concurrent/CopyOnWriteArrayList;->get(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lorg/greenrobot/eventbus/s;

    iget-object v0, v0, Lorg/greenrobot/eventbus/s;->b:Lorg/greenrobot/eventbus/q;

    iget v0, v0, Lorg/greenrobot/eventbus/q;->d:I
    ...
    .line 178
    iget-boolean v0, p2, Lorg/greenrobot/eventbus/q;->e:Z
    ...
    .line 189
    invoke-direct {p0, v4, v0}, Lorg/greenrobot/eventbus/c;->b(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
...
.method private a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;Ljava/lang/Throwable;)V
    .locals 4

    .prologue
    .line 516
    instance-of v0, p2, Lorg/greenrobot/eventbus/p;
    ...
    iget-object v3, p1, Lorg/greenrobot/eventbus/s;->a:Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v2, p3}, Lorg/greenrobot/eventbus/i;->a(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V

    .line 521
    check-cast p2, Lorg/greenrobot/eventbus/p;
    ...
    iget-object v3, p2, Lorg/greenrobot/eventbus/p;->c:Ljava/lang/Object;
    ...
    iget-object v3, p2, Lorg/greenrobot/eventbus/p;->d:Ljava/lang/Object;
    ...
    iget-object v3, p2, Lorg/greenrobot/eventbus/p;->b:Ljava/lang/Throwable;

    invoke-interface {v0, v1, v2, v3}, Lorg/greenrobot/eventbus/i;->a(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v1, p3}, Lorg/greenrobot/eventbus/g;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v1, p1, Lorg/greenrobot/eventbus/s;->a:Ljava/lang/Object;

    invoke-direct {v0, p0, p3, p2, v1}, Lorg/greenrobot/eventbus/p;-><init>(Lorg/greenrobot/eventbus/c;Ljava/lang/Throwable;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;Z)V
    .locals 3
    ...
    iget-object v1, p1, Lorg/greenrobot/eventbus/s;->b:Lorg/greenrobot/eventbus/q;

    iget-object v1, v1, Lorg/greenrobot/eventbus/q;->b:Lorg/greenrobot/eventbus/ThreadMode;
    ...
    iget-object v2, p1, Lorg/greenrobot/eventbus/s;->b:Lorg/greenrobot/eventbus/q;

    iget-object v2, v2, Lorg/greenrobot/eventbus/q;->b:Lorg/greenrobot/eventbus/ThreadMode;
    ...
    .line 430
    :pswitch_0
    invoke-virtual {p0, p1, p2}, Lorg/greenrobot/eventbus/c;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
    ...
    .line 436
    :cond_0
    iget-object v0, p0, Lorg/greenrobot/eventbus/c;->j:Lorg/greenrobot/eventbus/n;

    invoke-interface {v0, p1, p2}, Lorg/greenrobot/eventbus/n;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/greenrobot/eventbus/b;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/greenrobot/eventbus/a;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
...
.method private a(Ljava/lang/Object;Lorg/greenrobot/eventbus/c$a;Ljava/lang/Class;)Z
    ...
    .line 408
    iput-object v0, p2, Lorg/greenrobot/eventbus/c$a;->d:Lorg/greenrobot/eventbus/s;

    .line 411
    :try_start_1
    iget-boolean v3, p2, Lorg/greenrobot/eventbus/c$a;->c:Z

    invoke-direct {p0, v0, p1, v3}, Lorg/greenrobot/eventbus/c;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;Z)V
    ...
    .line 415
    iput-object v4, p2, Lorg/greenrobot/eventbus/c$a;->d:Lorg/greenrobot/eventbus/s;
...
.method private b(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, v0}, Lorg/greenrobot/eventbus/c;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;Z)V
...
.method private d()Z
    ...
    invoke-interface {v0}, Lorg/greenrobot/eventbus/j;->a()Z
...
.method public a(Ljava/lang/Object;)V
    ...
    .line 140
    iget-object v1, p0, Lorg/greenrobot/eventbus/c;->m:Lorg/greenrobot/eventbus/r;

    invoke-virtual {v1, v0}, Lorg/greenrobot/eventbus/r;->a(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 143
    invoke-direct {p0, p1, v0}, Lorg/greenrobot/eventbus/c;->a(Ljava/lang/Object;Lorg/greenrobot/eventbus/q;)V
...
.method a(Lorg/greenrobot/eventbus/l;)V
    .locals 3

    .prologue
    .line 497
    iget-object v0, p1, Lorg/greenrobot/eventbus/l;->a:Ljava/lang/Object;

    .line 498
    iget-object v1, p1, Lorg/greenrobot/eventbus/l;->b:Lorg/greenrobot/eventbus/s;

    .line 499
    invoke-static {p1}, Lorg/greenrobot/eventbus/l;->a(Lorg/greenrobot/eventbus/l;)V

    .line 500
    iget-boolean v2, v1, Lorg/greenrobot/eventbus/s;->c:Z

    if-eqz v2, :cond_0

    .line 501
    invoke-virtual {p0, v1, v0}, Lorg/greenrobot/eventbus/c;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
...
.method a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
    .locals 4

    .prologue
    .line 507
    :try_start_0
    iget-object v0, p1, Lorg/greenrobot/eventbus/s;->b:Lorg/greenrobot/eventbus/q;

    iget-object v0, v0, Lorg/greenrobot/eventbus/q;->a:Ljava/lang/reflect/Method;
    ...
    invoke-direct {p0, p1, p2, v0}, Lorg/greenrobot/eventbus/c;->a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public c()Lorg/greenrobot/eventbus/i;
    .locals 1
