.class public Lorg/greenrobot/eventbus/h;
...
.method protected constructor <init>(Lorg/greenrobot/eventbus/c;Landroid/os/Looper;I)V
    ...
    .line 32
    iput-object p1, p0, Lorg/greenrobot/eventbus/h;->c:Lorg/greenrobot/eventbus/c;

    .line 33
    iput p3, p0, Lorg/greenrobot/eventbus/h;->b:I
    ...
    iput-object v0, p0, Lorg/greenrobot/eventbus/h;->a:Lorg/greenrobot/eventbus/m;
...
.method public a(Lorg/greenrobot/eventbus/s;Ljava/lang/Object;)V
    ...
    .line 40
    :try_start_0
    iget-object v1, p0, Lorg/greenrobot/eventbus/h;->a:Lorg/greenrobot/eventbus/m;

    invoke-virtual {v1, v0}, Lorg/greenrobot/eventbus/m;->a(Lorg/greenrobot/eventbus/l;)V

    .line 41
    iget-boolean v0, p0, Lorg/greenrobot/eventbus/h;->d:Z
    ...
    iput-boolean v0, p0, Lorg/greenrobot/eventbus/h;->d:Z

    .line 43
    invoke-virtual {p0}, Lorg/greenrobot/eventbus/h;->obtainMessage()Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/greenrobot/eventbus/h;->sendMessage(Landroid/os/Message;)Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 56
    :cond_0
    iget-object v0, p0, Lorg/greenrobot/eventbus/h;->a:Lorg/greenrobot/eventbus/m;
    ...
    .line 78
    iput-boolean v6, p0, Lorg/greenrobot/eventbus/h;->d:Z
    ...
    :cond_2
    :try_start_3
    iget-object v1, p0, Lorg/greenrobot/eventbus/h;->c:Lorg/greenrobot/eventbus/c;
    ...
    .line 69
    iget v4, p0, Lorg/greenrobot/eventbus/h;->b:I
